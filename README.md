...
**Note:** go-get or vendor this package as `github.com/inspurDTest/cloud-provider`.
...
https://github.com/kubernetes/kubernetes/blob/master/staging/src/github.com/inspurDTest/cloud-provider.
...
## Things you should NOT do
 ...
 2. Directly modify anything under vendor/github.com/inspurDTest/cloud-provider in this repo. Those are driven from `k8s.io/kubernetes/staging/src/github.com/inspurDTest/cloud-provider`.
