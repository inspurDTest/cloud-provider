...
1. Have your external repo under k8s.io. e.g. `github.com/inspurDTest/cloud-provider-<provider>`
...
## Things you should NOT do
 ...
 2. Directly modify anything under `vendor/github.com/inspurDTest/cloud-provider/sample` in this repo. Those are driven from `k8s.io/kubernetes/staging/src/github.com/inspurDTest/cloud-provider/sample`.
