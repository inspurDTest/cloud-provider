...
import (
	...
	ccmconfig "github.com/inspurDTest/cloud-provider/config"
	ccmconfigscheme "github.com/inspurDTest/cloud-provider/config/install"
	ccmconfigv1alpha1 "github.com/inspurDTest/cloud-provider/config/v1alpha1"
