...
import (
	...
	endpointSliceconfig "k8s.io/cloud-provider/controllers/endpointSlice/config"
)
...
func Convert_v1alpha1_EndpointSliceControllerConfiguration_To_config_EndpointSliceControllerConfiguration(in *EndpointSliceControllerConfiguration, out *endpointSliceconfig.EndpointSliceControllerConfiguration, s conversion.Scope) error {
...
func Convert_config_EndpointSliceControllerConfiguration_To_v1alpha1_EndpointSliceControllerConfiguration(in *endpointSliceconfig.EndpointSliceControllerConfiguration, out *EndpointSliceControllerConfiguration, s conversion.Scope) error {
